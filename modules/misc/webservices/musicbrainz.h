...
musicbrainz_recording_t * musicbrainz_lookup_recording_by_toc(vlc_object_t *,
                                                              const char *, const char *);
musicbrainz_recording_t * musicbrainz_lookup_recording_by_discid(vlc_object_t *,
                                                                 const char *, const char *);
...
coverartarchive_t * coverartarchive_lookup_releasegroup(vlc_object_t *, const char *);
