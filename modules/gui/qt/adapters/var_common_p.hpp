...
public:
    ...
    void reset(vlc_object_t* obj, bool hold) override {
        m_object.reset(obj, hold);
    }

private:
    static void obj_hold( vlc_object_t* obj ) { vlc_object_hold(obj); }
    static void obj_release( vlc_object_t* obj ) { vlc_object_release(obj); }
    typedef vlc_shared_data_ptr_type(vlc_object_t, obj_hold, obj_release) SharedPtr;
    SharedPtr m_object;
};
